...
const Footer = () => {
    return (
                       ...
                       <ul role="list" className="flex text-center md:flex-row flex-col w-6/12 justify-center md:justify-center gap-6 mb-4">
                           {navigation.map((link, index) => (
                               <li key={index} role="listitem">
                                   <a href={link.href} className={`hover:text-primary ${link.current ? 'font-bold' : ''}`}>
                                       {link.name}
                                   </a>
                               </li>
                           ))}
        ...
        <span className="text-sm tracking-wide">Copyright ©2024 Moeen-Qadir <span id="year"></span> | All right reserved</span
        >
                    </div>
                </div>
            </div>
