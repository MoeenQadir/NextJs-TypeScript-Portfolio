...
const navigation: NavigationItem[] = [
    { name: 'Home', href: '#/', current: true, title: 'Home | Moeen Ul Qadir - Software Engineer | Full Stack Developer', description: 'Welcome to the home page of Moeen Ul Qadir, a software engineer and full stack developer. Explore our services and projects.', keywords: 'software engineer, full stack developer, home' },
